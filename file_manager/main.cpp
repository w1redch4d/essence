...
const char *errorTypeStrings[] = {
	...
	interfaceString_FileManagerDeleteItemError
};
...
struct Instance : EsInstance {
	...
	EsCommand commandNewFolder, commandRename, commandDelete;
...
struct NamespaceHandler {
	...
	EsError (*deleteItem)(Folder *folder, String name); // Optional.
